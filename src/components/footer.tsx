...
export const Footer = () => (
  <footer className="flex flex-col md:flex-row flex-none place-content-[center_flex-start] items-center gap-0 w-full h-auto md:h-screen md:max-h-60 p-0 relative overflow-hidden border-y border-solid border-white/10">
