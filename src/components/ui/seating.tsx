...
import {CSSProperties, Fragment, forwardRef, useCallback, useImperativeHandle, useRef, useState} from 'react'
...
export const SeatingArrangementTables = forwardRef<HTMLDivElement, SeatingArrangementTablesProps>(
  ({main, left, right}, ref) => {
