...
export const Section = forwardRef<HTMLElement, SectionProps>(({id, right, left}, ref) => (
  <section
    ref={ref}
    id={id}
    className="flex flex-col md:flex-row flex-none place-content-[center_flex-start] items-stretch gap-0 w-full h-auto p-0 relative border-t border-solid border-border"
  >
